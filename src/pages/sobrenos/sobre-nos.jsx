      ...
      >
        <div className="QuadradoVerde1">
          ...
          <p className="pV1">
            ...
            ato simples, em uma poderosa ferramenta de expressão e autonomia,
            garantindo que a inovação alcance a todos.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="Texto2">
          <img
            className="IconAzul"
            src={olhoAzul}
            alt="Icone de um olho azul"
          />
          <h2>Nossa Visão</h2>
          <p>
            Nossa visão é ser a ponte tecnológica que rompe barreiras e minimiza
            o isolamento social. Queremos garantir que cada indivíduo,
            independente de suas limitações físicas, encontre no Sopro o caminho
            para a plena conexão com o mundo e com as pessoas ao seu redor.
          </p>
        </div>

        <img
          className="Img2"
          src={imgSection2SobreNos}
          ...
          <div className="containercards">
            ...
            <div className="card-laranja">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/jaiane-soares"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-suave-global"
                  >
                    <img src={github} alt="icone do github" />
                  </a>
                  <a
                    href="https://www.linkedin.com/in/jaiane-d-5897802b5/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-azul">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/Gabriel-Silva-Tech"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/gabriel-concei%C3%A7%C3%A3o-ds/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-roxo">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  ...
                  <a
                    href="https://www.linkedin.com/in/iasmin-lopes-moreira/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-verde">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/FilipeAp"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/o-filipe-apolinario/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-azul">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/araujobrito"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/araujobrito/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-laranja">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/brunoasouza15004-hash"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/bruno-asouza/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-verde">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  <a
                    href="https://github.com/raquelalve"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/raquel-alves-044743385/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
            ...
            <div className="card-roxo">
              ...
              <div className="conteudoperfil">
                ...
                <div className="conteiner-icone">
                  ...
                  <a
                    href="https://www.linkedin.com/in/rubens-frsilva/"
                    target="_blank"
                    rel="noreferrer"
                    className="btn-suave-global"
                  >
